...
<body>
    ...
    <div class="wrapper">
        <h1 style="color: black;"> <b>CHANGE PASSWORD</b></h1>
        <br>
        <br>
        <br>
        ...
        <label for="psw-repeat" style="color: black;"><b>CONFIRM PASSWORD</b></label>
        ...
        <span class="help-block"><?php echo $confirm_password_err; ?>
            ...
            <div class="form-group">
                    <div class="btn">
                        <input type="submit" style="margin-left: 120px;" class="btn btn-primary" value="Submit">  
                    </div>
            </div>
      ...
      <p style="margin-left: 50px; color: darkred;"><b>Already have an account? <a href="register.php">Sign in</a>.</b></p>
    </div>
