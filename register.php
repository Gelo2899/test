...
<body>
    <div class="wrapper">
        <h1 style="color: black;"><b>REGISTER</b></h1>
        <br>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label style="color: black;"><b>CONFIRM PASSWORDS</b></label>
            ...
            <p style="margin-left: 90px; color: darkred;"><b>Already have an account? <a href="login.php">Login here</a></b>.</p>
        </form>
    </div>    
</body>
</html>
