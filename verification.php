...
<body>
    ...
    <div class="wrapper">
        <h1 style="color: black;">VERIFICATION</h1>
        
        
        <form role="form" method="post">

                <div class="form-group">
                    <label style="font-size: 30px; margin-left: 120px; color: black;">Code</label>
                    <br>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <br>
                    <a class="" style=" color: darkred; margin-left: 70px;" href="random.php" target="_blank"><u><b>CLICK THIS TO GET YOUR CODE HERE!</b></u></a>
                </div>
