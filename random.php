...
<body>
<h1 style="color: black; margin-left: 625px;"> YOUR CODE IS: <h1>
        <div class="cd">
            <h1 style="color: black; margin-left: 35px;"><b><?php echo $_SESSION["codee"]; ?> </b></h1>
        </div>
        <br>
        <a class="" style=" color: darkred; font-size: 20px;" href="verification.php" target="_blank"> <b>Enter your verification code here.</b></a>
